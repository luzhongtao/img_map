    ...
    jQuery.fn.imageMaps = function(setting) {
        ...
        $container.each(function(){
            ...
            $images.each(function(){
                ...
                _img_conrainer.append('<div class="button-conrainer"><input type="button" value="Add Link" /></div>').append('<div class="link-conrainer"></div>').append($.browser.msie ? $('<div class="position-conrainer" style="position:absolute"></div>').css({
                    background:'#fff',
                    opacity:0
...
//                        _link_conrainer.append('<p ref="'+index+'" class="map-link"><span class="link-number-text">Link '+index+'</span>: <input type="text" size="60" name="link'+image_param+'[]" value="'+$(this).attr('href')+'" /><input type="hidden" class="rect-value" name="rect'+image_param+'[]" value="'+coords+'" /></p>');
                            _link_conrainer.append('<p id="p'+index+'" ref="'+index+'" class="map-link">' +
                            '<span class="link-number-text">Link '+index+'</span>: <input type="text" size="60" name="link'+image_param+'[]" value="'+$(this).attr('href')+'" />' +
                            '   <span class="link-number-text">文字</span>: <input type="text" size="60" name="content'+image_param+'[]" value="" />' +
                            '<input type="hidden" class="rect-value" name="rect'+image_param+'[]" value="'+coords+'" /></p>');
                        coords = coords.split(',');
...
//            _link_conrainer.append('<p ref="'+index+'" class="map-link"><span class="link-number-text">Link '+index+'</span>: <input type="text" size="60" name="link'+image+'[]" value="" /><input type="hidden" class="rect-value" name="rect'+image+'[]" value="10,10,100,40" /></p>');
            _link_conrainer.append('<p id="p'+index+'"  ref="'+index+'" class="map-link">' +
                '<span class="link-number-text">Link '+index+'</span>: <input type="text" size="60" name="link'+image+'[]" value="" />' +
                '   <span class="link-number-text">文字</span>: <input type="text" size="60" name="content'+image+'[]" value="" />' +
                '<input type="hidden" class="rect-value" name="rect'+image+'[]" value="10,10,100,40" /></p>');
